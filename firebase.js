...
import { getFirestore, collection, addDoc, getDocs, onSnapshot, getTask } from "https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js"
...
export const getTask = (id) => getDoc(doc(db, "class", id))